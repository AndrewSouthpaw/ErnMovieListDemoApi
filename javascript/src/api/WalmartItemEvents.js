...
export default class WalmartItemEvents {
    constructor(bridge) {
        this._bridge = bridge;
            ...
            return   this._bridge.registerEventListener("com.ErnMovieListDemoApi.ern.api.event.itemAdded", eventListener);
            }
...
//------------------------------------------------------------------------------------------------------------------------------------
            ...
            emitItemAdded(itemId: string): void {
                    return this._bridge.emitEvent("com.ErnMovieListDemoApi.ern.api.event.itemAdded", { data:itemId });
