...
public final class WalmartItemApi {
    ...
    public interface Events {
        String EVENT_ITEM_ADDED = "com.ErnMovieListDemoApi.ern.api.event.itemAdded";
    ...
    public interface Requests {
        String REQUEST_ADD_ITEM = "com.ErnMovieListDemoApi.ern.api.request.addItem";
        String REQUEST_FIND_ITEMS = "com.ErnMovieListDemoApi.ern.api.request.findItems";
