...
@objcMembers public class WalmartItemAPI: NSObject  {
    ...
    static let kRequestAddItem = "com.ErnMovieListDemoApi.ern.api.request.addItem";

    static let kRequestFindItems = "com.ErnMovieListDemoApi.ern.api.request.findItems";
    static let kEventItemAdded = "com.ErnMovieListDemoApi.ern.api.event.itemAdded";
